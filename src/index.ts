...
import x$select from './utils/selector';

let overCount = 0;
let menuBar = x$.byId('menu');
let fullIemList = x$select('#menu>li');
let menu = new Grid('#menu>.show', {
	name: 'menu',
	grid: { cols: 6 },
	forceRec: 'strict',
	hoverClass: 'hover',
